...
## Предусловия:
Тестируемое приложение запускается по инструкции, указанной в файле READ.me
...
1. В поле "Месяц" ввести валидное значение-08
1. В поле "Год" ввести валидное значение-22
1. В поле "Владелец" ввести валидное значение русскими буквами-Ирина Василенко
1. В поле CVC/CVV ввести валидное значение-999
...
1. В поле "Год" ввести валидное значение-22.
1. В поле "Владелец" ввести валидное значение латинскими буквами-Irina Vasilenko
1. В поле CVC/CVV ввести валидное значение-999
1. Нажать на кнопку "Продолжить"
...
Ожидаемый результат: поле "Месяц" подсвечено как ошибочное. Надпись под полем "Неверно введены данные карты"
...
1. В поле "Месяц" ввести валидное значение-текущий месяц
1. В поле "Год" ввести валидное значение-22.
1. В поле "Владелец" ввести невалидное значение русскими буквами-Ирина
1. В поле CVC/CVV ввести валидное значение-999
1. Нажать на кнопку "Продолжить"
...
1. В поле "Месяц" ввести валидное значение-текущий месяц
1. В поле "Год" ввести валидное значение-22.
1. В поле "Владелец" ввести невалидное значение латинскими буквами-Irina
1. В поле CVC/CVV ввести валидное значение-999
1. Нажать на кнопку "Продолжить"
...
1. В поле "Месяц" ввести валидное значение-текущий месяц
1. В поле "Год" ввести валидное значение-22.
1. В поле "Владелец" ввести невалидное значение русскими буквами-Василенко
1. В поле CVC/CVV ввести валидное значение-999
1. Нажать на кнопку "Продолжить"
...
1. В поле "Месяц" ввести валидное значение-текущий месяц
1. В поле "Год" ввести валидное значение-22.
1. В поле "Владелец" ввести невалидное значение латинскими буквами-Vasilenko
1. В поле CVC/CVV ввести валидное значение-999
1. Нажать на кнопку "Продолжить"
...
1. В поле "Месяц" ввести валидное значение-текущий месяц
1. В поле "Год" ввести валидное значение-22.
1. В поле "Владелец" ввести невалидное значение имя и фамилию через дефис-Ирина-Василенко
1. В поле CVC/CVV ввести валидное значение-999
1. Нажать на кнопку "Продолжить"

Ожидаемый результат: поле "Владелец" подсвечено как ошибочное. Надпись под полем "Поле заполнено неверно"
...
1. В поле "Месяц" ввести валидное значение-текущий месяц
1. В поле "Год" ввести валидное значение-22.
1. В поле "Владелец" ввести невалидное значение-и
1. В поле CVC/CVV ввести валидное значение-999
1. Нажать на кнопку "Продолжить"
...
1. В поле "Месяц" ввести валидное значение-текущий месяц
1. В поле "Год" ввести валидное значение-22.
1. В поле "Владелец" ввести валидное значение-Ирина Василенко
1. В поле CVC/CVV ввести невалидное значение-9
1. Нажать на кнопку "Продолжить"
...
1. В поле "Год" ввести валидное значение-22.
1. В поле "Владелец" ввести валидное значение-Ирина Василенко
1. В поле CVC/CVV ввести невалидное значение-99
1. Нажать на кнопку "Продолжить"
...
1. В поле "Год" ввести валидное значение-22.
1. В поле "Владелец" ввести валидное значение-Ирина Василенко
1. В поле CVC/CVV ввести невалидное значение-99В поле CVC/CVV ввести невалидное значение-99ничего не вводить. Оставить поле пустым
1. Нажать на кнопку "Продолжить"
...
1. В поле "Год" ввести валидное значение-22.
1. В поле "Владелец" ввести валидное значение-Ирина Василенко
1. В поле CVC/CVV ввести невалидное значение-99ничего не вводить. Оставить поле пустым
1. Нажать на кнопку "Продолжить"
...
- IntellijIDEA Ultimate 2020.3.1-среда разработки, поддерживающая множество плагинов, систем управления и контроля версий
...
- Selenide 5.11 -  библиотека для написания лаконичных и стабильных UI тестов с открытым исходным кодом  на основе Selenium WebDriver.
...
- Allure 2 - фреймворк,предназначенныйдля создания визуально нагляднойкартины выполнения тестов.Генерирует более интересные отчёты, чем Gradle.
...
1. Отсутствие test-id в css-селекторах усложняет написание авто-тестов.
1. Использование двух БД может привести к затруднениям и проблемам.

## Интервальная оценка с учётом рисков (в часах)

1. Создание проекта и запуск SUT-8 часов(нахожусь в турецкой локали и не всегда SUT запускается с первого раза).
1. Написание тест-плана - 6 часов.
1. Написание и прогон автотестов - 60 часов.
1. Дополнительное время на устранение замечаний - 15 часов.
1. Подготовка отчетов по итогам тестирования - 10 часов.
1. Подготовка учетных документов по итогам автоматизации - 8 часов.

## План сдачи работ
1. Автотесты - 14 дней после утверждения плана.
